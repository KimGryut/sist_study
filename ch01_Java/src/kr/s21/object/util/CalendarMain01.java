...
public class CalendarMain01 {
	public static void main(String[] args) {
		...
		int month = today.get(Calendar.MONTH) + 1; // 월 -> 0부터 11 값을 반환하기 때문에 +1 해줘야 함
